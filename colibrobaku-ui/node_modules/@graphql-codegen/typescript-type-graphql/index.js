...
class TypeGraphQLVisitor extends typescript.TsVisitor {
    constructor(schema, pluginConfig, additionalConfig = {}) {
        ...
        const enumNames = Object.values(schema.getTypeMap())
            ...
            .filter(t => t);
        this.setArgumentsTransformer(new typescript.TypeScriptOperationVariablesToObject(this.scalars, this.convertName, this.config.avoidOptionals, this.config.immutableTypes, null, enumNames, this.config.enumPrefix, this.config.enumValues, undefined, undefined, 'Maybe'));
...
const plugin = (schema, documents, config) => {
    ...
    const introspectionDefinitions = typescript.includeIntrospectionTypesDefinitions(schema, documents, config);
